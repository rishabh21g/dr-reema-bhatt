  ...
  const blogPosts = [
    {
      ...
      excerpt: 'Learn about the importance of fetal medicine in modern pregnancy care and how early detection can improve outcomes for both mother and baby.',
...
Remember, every pregnancy is unique, and personalized care is essential for the best outcomes. If you have concerns about your pregnancy, don't hesitate to seek specialized fetal medicine care.`,
    ...
    },
    {
      ...
      excerpt: 'Understanding high-risk pregnancies and how specialized care can ensure the best outcomes for both mother and baby.',
...
Remember, being classified as high-risk doesn't mean something will go wrong. It simply means you need specialized care to ensure the best possible outcome for you and your baby.`,
    ...
    },
    {
      ...
      excerpt: 'The importance of genetic counseling in pregnancy and how it helps families make informed decisions about their baby\'s health.',
...
Remember, genetic counseling is about empowerment through knowledge. It helps you make the best decisions for your family based on accurate, personalized information.`,
      ...
      icon: Brain,
      image: 'https://images.pexels.com/photos/6823321/pexels-photo-6823321.jpeg?auto=compress&cs=tinysrgb&w=800'
    }
  ];
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex items-center justify-between">
              ...
              <Link href="/" className="flex items-center space-x-2">
                ...
                <span className="font-semibold text-gray-900">Dr. Reema Bhatt</span>
              </Link>
            </div>
          </div>
        </header>
              ...
              <div className="flex items-center mb-8 pb-8 border-b border-gray-200">
                ...
                <div>
                  <div className="flex items-center">
                    ...
                    <span className="font-medium text-gray-900">Dr. Reema Bhatt</span>
                  </div>
                  <p className="text-sm text-gray-600">Fetal Medicine Specialist</p>
                </div>
              </div>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-br from-green-50 to-emerald-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Badge className="mb-4 bg-green-100 text-green-800">Medical Insights</Badge>
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Fetal Medicine <span className="text-primary">Blog</span>
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Expert insights on fetal medicine, high-risk pregnancies, and genetic counseling 
            from Dr. Reema Bhatt to help you make informed decisions about your pregnancy journey.
          </p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
            {blogPosts.map((post) => (
              <Card key={post.id} className="border-green-100 hover:shadow-xl transition-all duration-300 group cursor-pointer">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">
            Stay Updated with Fetal Medicine Insights
          </h2>
          <p className="text-lg text-gray-600 mb-8">
            Subscribe to receive the latest insights on fetal medicine, pregnancy care, and 
            genetic counseling directly from Dr. Reema Bhatt.
          </p>
